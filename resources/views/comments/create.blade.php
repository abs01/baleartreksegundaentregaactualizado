    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white shadow-md rounded-lg">
            <div class="bg-gray-100 px-6 py-4 border-b">
                <h2 class="text-2xl font-bold">Create Meeting</h2>
            </div>
...
<script>
    ...
    // Set minimum date for appDateIni to today
    const today = new Date().toISOString().split('T')[0];
    document.getElementById('appDateIni').min = today;
    
    // Set initial min value for appDateEnd if appDateIni has a value
